...
export const adminNavigation: AdminNavigationGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/invoices", label: "发票管理", description: "发票申请与开具记录", permission: "orders.read", state: "setup" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/customer-tags", label: "客户标签与分组", description: "标签、分群与运营人群", permission: "customers.read", state: "setup" },
      { href: "/admin/memberships", label: "会员等级", description: "会员规则与客户等级", permission: "customers.read", state: "setup" },
      { href: "/admin/loyalty", label: "积分与余额", description: "积分、余额与流水", permission: "customers.read", state: "setup" },
      { href: "/admin/abandoned-carts", label: "购物车与弃购", description: "弃购识别与提醒任务", permission: "customers.read", state: "setup" },
      { href: "/admin/news", label: "新闻管理", description: "新闻列表、草稿和发布", permission: "customers.read" },
      { href: "/admin/news-operations", label: "新闻自主运营", description: "发布计划与审核队列", permission: "customers.read", state: "setup" },
  ...
  },
  {
    label: "数据与系统",
    items: [
      { href: "/admin/analytics/traffic", label: "访问分析", description: "访客、页面与访问趋势", permission: "analytics.read", state: "setup" },
      { href: "/admin/analytics/attribution", label: "来源归因", description: "渠道与订单来源归因", permission: "analytics.read", state: "setup" },
      { href: "/admin/analytics/funnel", label: "转化漏斗", description: "浏览、加购、结账与支付漏斗", permission: "analytics.read", state: "setup" },
      ...
      { href: "/admin/reports/customers", label: "客户分析", description: "客户增长、复购与价值分析", permission: "analytics.read", state: "setup" },
      { href: "/admin/sync", label: "数据同步", description: "渠道、库存和内容同步任务", permission: "settings.read", state: "setup" },
