...
function Contact() { return <><PageHead eyebrow="Product information" title="Request product details" intro="This catalogue is available for product discovery. Pricing, minimum order quantity, shipping, regional availability and model-specific compliance documentation are provided by the sales team on request."/><section className="shell pb-16"><div className="max-w-2xl rounded-3xl bg-[var(--surface)] p-7"><h2 className="text-2xl font-black">Before placing an order</h2><ul className="mt-5 grid gap-3 leading-7 text-[var(--muted)]"><li>• Confirm the exact model, lens configuration and required quantity.</li><li>• Request the applicable price, delivery terms and market availability.</li><li>• Verify product-specific compliance documents for your import or distribution market.</li></ul></div></section></>; }
