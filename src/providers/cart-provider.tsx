...
type Action = { type: "hydrate"; state: Partial<CartState> } | { type: "add"; line: CartLine } | { type: "setQuantity"; key: Pick<CartLine, "productId" | "skuId">; quantity: number } | { type: "remove"; key: Pick<CartLine, "productId" | "skuId"> } | { type: "clear" } | { type: "currency"; currency: CurrencyCode };
...
function reducer(state: CartState, action: Action): CartState {
  ...
  if (action.type === "clear") return { ...state, lines: [] };
...
const CartContext = createContext<(CartState & { add(line: CartLine): void; setQuantity(key: Pick<CartLine, "productId" | "skuId">, quantity: number): void; remove(key: Pick<CartLine, "productId" | "skuId">): void; clear(): void; setCurrency(currency: CurrencyCode): void }) | null>(null);
